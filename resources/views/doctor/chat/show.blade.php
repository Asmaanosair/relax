...
<div class="messages">
    ...
    @forelse($patients_id as $patient_id)
        ...
        {{!$myfriend = App\User::where('id',$patient_id->patient_id)->get()->first()}}

        <div class="chat-rect">

            <a class="img-chat" href="{{route('chat.show',$myfriend->id)}}">
            ...
            <div class="message-info">
                ...
                <h1 class="message-info__person"><a href="{{route('chat.show',$myfriend->id)}}">{{$myfriend->name}}</a></h1>
