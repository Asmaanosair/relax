<template>
    <div>
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="btn-group the-btn" role="group">
                        <button
                            type="button"
                ...
                <div class="col-12 video-container" v-if="callPlaced">
                    ...
                    <div class="action-btns">
                        ...
                        <button type="button" class="btn btn-info" @click="toggleMuteAudio">
                            ...
                            <span v-if="mutedAudio"> <i class="fa fa-microphone-slash"></i></span>
                            <span v-else> <i class="fa fa-microphone"></i></span>
                        </button>
                        <button
                            type="button"
                        ...
                        >
                            <span v-if="mutedVideo"> <i class="fa fa-video"></i></span>
                            <span v-else> <i class="fa fa-video-slash"></i></span>
            ...
            <div class="row" v-if="incomingCallDialog">
                <div class="col">
                    <p>
                        Incoming Call From
<!--                        <strong>{{ callerDetails.name }}</strong>-->
                    </p>
...
export default {
    ...
    methods: {
        initializeChannel() {
            this.videoCallParams.channel = window.Echo.join("video-chat-development");
        ...
        initializeCallListeners() {
            ...
            // listen to Incoming call call
            this.videoCallParams.channel.listen("StartVideoEmergency", ( { data }) => {
...
.container{
    ...
    url(https://callminer.com/wp-content/uploads/stockfresh_8245621_female-customer-services-agent-in-call-center_sizeS.jpg
    );
    ...
    -webkit-animation: back 18s infinite alternate;
    animation: back 18s infinite alternate;
}
