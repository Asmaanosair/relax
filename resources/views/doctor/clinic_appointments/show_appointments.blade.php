                ...
                <table class="w-100 text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" class="dropdown-item" data-toggle="modal" data-target="#Modal{{$appointment->id}}">
                                <p>
                                    <img src="{{asset($appointment->image)}}" alt="" style="width:60px; height:60px; border-radius:50%">
                                    {{$appointment->name}}
                                </p>
                                <div>
                                    <span class="name">
                            ...
                            <div class="modal fade" id="Modal{{$appointment->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form action="{{route('doctor.internal_appointment_patients.update',$appointment->id)}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"> حالة الجلسة</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <select name="status" class="form-controll col-md-6">
                                                        ...
                                                        <option {{$loop->index == $appointment->status ? 'selected' : ''}} value="{{$loop->index}}">
                                                            {{$status}}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="modal-footer">
                                                <input type="submit" class="btn btn-success" value="تغيير الحالة">
                                            </div>
                                            @endif
